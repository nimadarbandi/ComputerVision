...
Img_DIMR_DeepSNiF = deepsnif.perform_IMC_Denoise(Img_raw, n_neighbours = args.n_neighbours, n_iter = args.n_iter, window_size = args.slide_window_size)

tp.imsave(args.Denoised_img_name, Img_DIMR_DeepSNiF.astype('float32'))
